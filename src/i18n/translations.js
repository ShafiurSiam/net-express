...
export const translations = {
  ...
  packagesPage: {
    ...
    comparison: {
      ...
      colSpeed: { bn: "ইন্টারনেট স্পিড", en: "Internet Speed" },
      colContention: { bn: "কনটেনশন রেশিও", en: "Contention Ratio" },
      colBdix: { bn: "BDIX ও ক্যাশ", en: "BDIX & Cache" },
      colRealIp: { bn: "রিয়েল আইপি", en: "Real IP" },
      colPrice: { bn: "মাসিক মূল্য", en: "Monthly Price" },
      colAction: { bn: "অর্ডার", en: "Order" },
      buyButton: { bn: "কিনুন", en: "Buy" },
      quoteButton: { bn: "কোট নিন", en: "Get a Quote" },
